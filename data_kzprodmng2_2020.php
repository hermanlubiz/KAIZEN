...
<div class="container-fluid-left" style="color: black">
  <center><h2 style="color: blue">DATA RECORD KAIZEN DEPARTEMENT PRODUKSI 2020</h2></center>

  <a href="data_kzprodmng2.php" button type="submit" class="btn btn-primary">Data Tahun 2021 <span class="glyphicon glyphicon-check"></span></a>
  ...
  <?php
  include "koneksi.php";
  $sql = mysqli_query($koneksi,"SELECT * from tb_kzprod2020 WHERE no_kaizen LIKE 'P%' ORDER BY id ASC");
  $count = mysqli_num_rows($sql);
  ?>
  <button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-home"></span> Total Data Kaizen Produksi <span class="badge"><?php echo $count ?></span></button>
  <a href="data_kzprodmng2_task.php" button type="submit" class="btn btn-primary">Clik Disini->Data Kaizen Produksi (Belum Verifikasi) <span class="glyphicon glyphicon-list"></span></a>
  ...
  <div class="form-group row button" style="margin-top: 0.5%;">
     ...
     <a href="data_kzprodmng2.php" type="submit" class="btn btn-danger">Back <span class="glyphicon glyphicon-repeat"></span></a>
   </div>
