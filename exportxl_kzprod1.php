...
if (isset($_GET['kode'])) {
$getdata = $_GET['kode'];
$sql = mysqli_query($koneksi,"SELECT * from tb_kzprod1 WHERE tb_kzprod1.no_kaizen LIKE '%$getdata%' ORDER BY id ASC");
}else{
$sql = mysqli_query($koneksi,"SELECT * from tb_kzprod1 ORDER BY id ASC");
}
