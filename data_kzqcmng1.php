...
<div class="container-fluid-left" style="color: black">
  <center><h2 style="color: blue">DATA RECORD KAIZEN DEPARTEMENT QC</h2></center>

  <a href="data_kzqcmng1_2020.php" button type="submit" class="btn btn-primary">Data Tahun 2020 <span class="glyphicon glyphicon-check"></span></a>
  ...
  <?php
  include "koneksi.php";
  $sql = mysqli_query($koneksi,"SELECT * from tb_kzprod1 WHERE no_kaizen LIKE 'C%' ORDER BY id ASC");
...
$sql = mysqli_query($koneksi,"SELECT * from tb_kzprod1 WHERE no_kaizen LIKE 'C%' ORDER BY id DESC");
}
...
<!-- untuk tabel scroll-->
<div  class="container-fluid-left" style="color: black;position: absolute-block;max-height: 655px;width:101.8%;overflow-y:auto;overflow-x:hidden;margin-top: 4%" >
