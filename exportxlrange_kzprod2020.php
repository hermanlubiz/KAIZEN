...
header("Content-Disposition: attachment; filename=kaizen_Range_Download.xls");
error_reporting(0);
?>

<center><h2 style="color: blue">DATA RECORD KAIZEN RANGE TANGGAL ALL DEPARTEMENT</h2></center>
<center><h4 style="color: red"><?php 
    include "koneksi.php";  
    $tgl1 = $_GET['tgl_awal'];
    $tgl2 = $_GET['tgl_akhir'];
   echo " Data Dari Tanggal : <b>".$tgl1."</b>". " S/D Tanggal : <b>".$tgl2."</b>";
   ?></h4></center>
