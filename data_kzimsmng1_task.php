...
<div class="container-fluid-left" style="color: black">
  <center><h2 style="color: blue">DATA RECORD KAIZEN DEPARTEMENT IMS-HSE BELUM VERIFIKASI</h2></center>

  <a href="data_kzimsmng1.php" button type="submit" class="btn btn-primary">Klik Disini->Data Semua Kaizen HSE <span class="glyphicon glyphicon-list"></span></a>
...
$sql = mysqli_query($koneksi,"SELECT * from tb_kzprod1 WHERE mngprod='' and no_kaizen LIKE 'S%' ORDER BY id ASC");
}
