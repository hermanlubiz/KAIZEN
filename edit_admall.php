    ...
    <div class="form-group row" style="display: none">
      ...
      include "koneksi.php";
       ...
       //$urut   = substr($kd, 5, 0);
          ...
          if (strpbrk($kdc, P)){
            $ke02 = "datauser_prod.php";
          }else if (strpbrk($kdc, A)) {
            $ke02 = "datauser_qa.php";
          }else if (strpbrk($kdc, C)){
            $ke02 = "datauser_qc.php";
          }else if (strpbrk($kdc, I)){
            $ke02 = "datauser_ppic.php";
          }else if (strpbrk($kdc, M)){
            $ke02 = "datauser_mtu.php";
          }else if (strpbrk($kdc, H)){
            $ke02 = "datauser_hrgs.php";
          }else if (strpbrk($kdc, E)){
            $ke02 = "datauser_eng.php";
          }else if (strpbrk($kdc, L)){
            $ke02 = "datauser_log.php";
          }else{
            $ke02 = "datauser_ims.php";
          }
