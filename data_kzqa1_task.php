...
<a href="data_kzqa1.php" button type="submit" class="btn btn-primary">Klik Disini->Data Semua Kaizen QA <span class="glyphicon glyphicon-list"></span></a>
...
$sql = mysqli_query($koneksi,"SELECT * from tb_kzprod1 WHERE dikaji='' and no_kaizen LIKE 'A%' ORDER BY id ASC");
}
