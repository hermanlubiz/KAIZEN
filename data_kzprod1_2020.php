...
<div class="container-fluid-left" style="color: black">
  <center><h2 style="color: blue">DATA RECORD KAIZEN ALL DEPARTEMENT 2020</h2></center>

<a href="data_kzprod1.php" button type="submit" class="btn btn-primary">Data Tahun 2021 <span class="glyphicon glyphicon-check"></span></a>
...
<a href="form_kzprod1.php" button type="submit" class="btn btn-primary">+ Tambah Input <span class="glyphicon glyphicon-check"></span></a>
  <a href="exportxl_kzprod2020.php" button type="submit" class="btn btn-warning">Save All Data To Excel  <span class="glyphicon glyphicon-download-alt"></span></a>
  <?php
  include "koneksi.php";
  $sql = mysqli_query($koneksi,"SELECT * from tb_kzprod2020");
...
$sql = mysqli_query($koneksi,"SELECT * from tb_kzprod2020 WHERE tgl_input BETWEEN '$tgl1' and '$tgl2' ORDER BY tgl_input ASC");
}else{
$sql = mysqli_query($koneksi,"SELECT * from tb_kzprod2020 WHERE tgl_input BETWEEN '2020-01-01' and '2020-12-31' ORDER BY id ASC");
}
...
<!-- untuk hidden data judul tabel -->
 <tr style="background-color: white;visibility:hidden;">
  ...
  <td><center><p><?php
                        ...
                        ?>
  <a class="btn btn-info btn-xs disabled" href= "verifiuseroe.php?id_edit=<?php echo $data->id ?>">Review <span class="glyphicon glyphicon-check"></span></a>
  </center></td>
  ...
  <a class="btn btn-primary btn-xs disabled" href= "verifimngoe.php?id_edit=<?php echo $data->id ?>">Review <span class="glyphicon glyphicon-check"></span></a>
  </center></td>
  ...
  <a class="btn btn-warning btn-xs disabled" data-toggle="modal" data-target="#myModal2" href= "verifioe.php?id_edit=<?php echo $data->id ?>">Verify <span class="glyphicon glyphicon-check"></span></a>
  </td></center>
...
<!-- untuk tabel scroll-->
<div  class="container-fluid-left" style="color: black;position: absolute-block;max-height: 755px;min-width:101.6%;overflow-y:auto;overflow-x:hidden;margin-top: 3.5%" >
...
<!-- untuk hidden data judul tabel -->
 <tr class="btn-default">
  ...
  <td><center>
  <a class="btn btn-info btn-xs" target="_blank" href= "cetak.php?id_edit=<?php echo $data->id ?>">View.&.print <span class="glyphicon glyphicon-print"></span></a> |
  <a class="btn btn-success btn-xs disabled" href= "edit_kzprod1.php?id_edit=<?php echo $data->id ?>">Edit <span class="glyphicon glyphicon-edit"></span></a> |
  <a class="btn btn-danger btn-xs disabled" href= "hapus_kzprod1.php?id_hapus=<?php echo $data->id ?>" onclick="return confirm('HELLO.... YOU SURE TO DELETE........??')">Hapus <span class="glyphicon glyphicon-trash"></span></a>
...
$(document).ready(function(){
  $("#myInput").on("keyup", function() {
    ...
    $("#myTable tr").filter(function() {
      ...
      var link = document.getElementById('myInput').innerHTML =  'exportxl_kzprod2020.php?kode=' + wk ; // utk mnghubungkan data text yang di cari masukan ke innerhtml utk buat link baru 
