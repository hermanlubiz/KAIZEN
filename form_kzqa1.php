<?php
include "ceklog_qa.php";
include "headerqa1.php";
?>
  ...
  <!-- Modal -->
   <div class="modal-dialog modal-lg">
    ...
    <div class="container">
      ...
      <?php
      include "koneksi.php";
       $no     = mysqli_query($koneksi,"SELECT no_kaizen FROM tb_kzprod1 WHERE no_kaizen like 'A%' ORDER BY no_kaizen DESC");
       ...
       if ($urut2!==$thn){
          ...
          if (strlen($tambah) == 1){
          $format = "A-".$thn."-"."00".$tambah;
          }else if (strlen($tambah) == 2) {
          $format = "A-".$thn."-"."0".$tambah;
          }else{
          $format = "A-".$thn."-".$tambah;
          }
      }
  ...
  <div class="form-group row">
    ...
    <div class="form-group row">
      ...
      <div class="col-xs-3" style="width: 19%; margin-left: -2.7%">
        ...
        <option></option>
          <option>Arie Ferdiani</option>
          <option>Siti Lathifah Noor Amir</option>
          <option>Dian Thoriqul Fitri</option>
          <option>Rindhu Shinta Rini</option>
          <option>Junaedi</option>
        </select>
      </div>
                ...
                move_uploaded_file($file_tmp, 'filesave/'.$nama_gambar_baru2); //memindah file gambar ke folder gambar
                  ...
                  if(!$result){
                    ...
                    // start php mailer;
                          ...
                          if ($a15=="Arie Ferdiani"){
                          $mail->AddAddress('arie.ferdiani@darya-varia.com');
                          }else if ($a15=="Siti Lathifah Noor Amir"){
                          $mail->AddAddress('siti.lathifah@darya-varia.com');
                          }else if ($a15=="Dian Thoriqul Fitri"){
                          $mail->AddAddress('dian.fitri@darya-varia.com');
                          }else if ($a15=="Rindhu Shinta Rini"){
                          $mail->AddAddress('dyan.rindhu@darya-varia.com');
                          }else ($a15=="Junaedi"){
                          $mail->AddAddress('junaedi.siahaan@darya-varia.com')
                          };

                          $mail->AddCC('emy.pujiastuti@darya-varia.com');
...
// end php mailer
                    ...
                    echo "<script>alert('Data berhasil ditambah.');window.location='form_kzqa1.php';</script>";
                  }

            }
            } else {     
             //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                echo "<script>alert('Ekstensi gambar yang boleh hanya jpg, png atau gif.');window.location='form_kzqa1.php';</script>";
            }
}
} else {
   $query = "INSERT INTO tb_kzprod1 (id,no_kaizen,area,oleh,judul,alasan,tipe,cat,masalah,tindakan,dampak,sebelum,img1,sesudah,img2,nm_spv,tgl_mulai,tgl_selesai,rps,mngprod,komen1,spvoe,komen2,status,ttdmng,ttdoe) 
