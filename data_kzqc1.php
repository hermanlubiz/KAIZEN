...
<a href="form_kzqc1.php" button type="submit" class="btn btn-primary">+ Tambah Input <span class="glyphicon glyphicon-check"></span></a>
  ...
  <a href="data_kzqc1_task.php" button type="submit" class="btn btn-primary">Klik Disini->Data Kaizen QC (Belum Verifikasi) <span class="glyphicon glyphicon-list"></span></a>
  ...
  <div class="form-group row button" style="margin-top: 0.5%;">
     ...
     <a href="data_kzqc1.php" type="submit" class="btn btn-danger">Back <span class="glyphicon glyphicon-repeat"></span></a>
   </div>
...
<!-- untuk tabel scroll-->
<div  class="container-fluid-left" style="color: black;position: absolute-block;max-height: 655px;width:101.8%;overflow-y:auto;overflow-x:hidden;margin-top: 4.2%" >
