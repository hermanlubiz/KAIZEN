...
<div class="container-fluid-left" style="color: black">
  <center><h2 style="color: blue">DATA RECORD KAIZEN DEPARTEMENT PPIC BELUM VERIFIKASI</h2></center>

  <a href="data_kzppicmng1.php" button type="submit" class="btn btn-primary">Klik Disini->Data Semua Kaizen PPIC <span class="glyphicon glyphicon-list"></span></a>
...
$sql = mysqli_query($koneksi,"SELECT * from tb_kzprod1 WHERE mngprod='' and no_kaizen LIKE 'I%' ORDER BY id ASC");
}
