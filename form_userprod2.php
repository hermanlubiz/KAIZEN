  ...
  <!-- Modal -->
   <div class="modal-dialog modal-lg">
    ...
    <div class="container">
      ...
      <?php
      include "koneksi.php";
       $no     = mysqli_query($koneksi,"SELECT no_kaizen FROM tb_kzprod1 WHERE no_kaizen like 'P%' ORDER BY no_kaizen DESC");
  ...
  <div class="form-group row">
    ...
    <div class="form-group row">
      ...
      <div class="col-xs-3" style="width: 19%; margin-left: -2.7%">
        ...
        <option></option>
          <option>Moses Prasetio</option>
          <option>Jauza Nurrianti</option>
          <option>Prastomo Wibisono</option>
          <option>Ade Mulyana</option>
          <option>Uliya Ita Rahmita</option>
          <option>Muhammad Iqbal</option>
          <option>Isni Rizqi Putri</option>
        </select>
      </div>
                ...
                move_uploaded_file($file_tmp, 'filesave/'.$nama_gambar_baru2); //memindah file gambar ke folder gambar
                  ...
                  if(!$result){
                    ...
                    // start php mailer;
                          ...
                          if ($a15=="Moses Prasetio"){
                          $mail->AddAddress('moses.prasetio@darya-varia.com');
                          }else if ($a15=="Jauza Nurrianti"){
                          $mail->AddAddress('jauza.nurrianti@darya-varia.com');
                          }else if ($a15=="Prastomo Wibisono"){
                          $mail->AddAddress('prastomo.wibisono@darya-varia.com');
                          }else if ($a15=="Ade Mulyana"){
                          $mail->AddAddress('ade.mulyana@darya-varia.com');
                          }else if ($a15=="Uliya Ita Rahmita"){
                          $mail->AddAddress('uliya.rahmita@darya-varia.com');
                          }else if ($a15=="Muhammad Iqbal"){
                          $mail->AddAddress('muhammad.iqbal@darya-varia.com');
                          }else ($a15=="Isni Rizqi Putri"){
                          $mail->AddAddress('isni.putri@darya-varia.com')
                          };


                          $mail->AddCC('antonius.dymita@darya-varia.com');
...
// end php mailer
                    ...
                    echo "<script>alert('Data berhasil ditambah.');window.location='form_userprod2.php';</script>";
                  }

            }
            } else {     
             //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                echo "<script>alert('Ekstensi gambar yang boleh hanya jpg, png atau gif.');window.location='form_userprod2.php';</script>";
            }
}
} else {
   $query = "INSERT INTO tb_kzprod1 (id,no_kaizen,area,oleh,judul,alasan,tipe,cat,masalah,tindakan,dampak,sebelum,img1,sesudah,img2,nm_spv,tgl_mulai,tgl_selesai,rps,mngprod,komen1,spvoe,komen2,status,ttdmng,ttdoe) 
