  ...
  <!-- Modal -->
   <div class="modal-dialog modal-lg">
    ...
    <div class="container">
      ...
      <?php
      include "koneksi.php";
       $no     = mysqli_query($koneksi,"SELECT no_kaizen FROM tb_kzprod1 WHERE no_kaizen like 'H%' ORDER BY no_kaizen DESC");
       ...
       if ($urut2!==$thn){
          ...
          if (strlen($tambah) == 1){
          $format = "H-".$thn."-"."00".$tambah;
          }else if (strlen($tambah) == 2) {
          $format = "H-".$thn."-"."0".$tambah;
          }else{
          $format = "H-".$thn."-".$tambah;
          }
      }
    ...
    <div class="form-group row">
      ...
      <div class="col-xs-3" style="width: 19%; margin-left: -2.7%">
        ...
        <option></option>
          ...
          <option>Agus Sukandar</option>
          <option>Fitriani Ilma Sakina</option>
        </select>
      </div>
                ...
                move_uploaded_file($file_tmp, 'filesave/'.$nama_gambar_baru2); //memindah file gambar ke folder gambar
                  ...
                  if(!$result){
                    ...
                    // start php mailer;
                          ...
                          if ($a15=="Kartini"){
                          $mail->AddAddress('kartini.mutiah@darya-varia.com');
                          }else if ($a15=="Fitriani Ilma Sakina"){
                          $mail->AddAddress('fitriani.sakina@darya-varia.com');
                          }else ($a15=="Agus Sukandar"){
                          $mail->AddAddress('agus.sukandar@darya-varia.com')
                          };

                          $mail->AddCC('teguh.suprijanto@darya-varia.com');
...
// end php mailer
                    ...
                    echo "<script>alert('Data berhasil ditambah.');window.location='form_kzhrgs1.php';</script>";
                  }

            }
            } else {     
             //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                echo "<script>alert('Ekstensi gambar yang boleh hanya jpg, png atau gif.');window.location='form_kzhrgs1.php';</script>";
            }
}
} else {
   $query = "INSERT INTO tb_kzprod1 (id,no_kaizen,area,oleh,judul,alasan,tipe,cat,masalah,tindakan,dampak,sebelum,img1,sesudah,img2,nm_spv,tgl_mulai,tgl_selesai,rps,mngprod,komen1,spvoe,komen2,status,ttdmng,ttdoe) 
