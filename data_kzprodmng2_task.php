...
<div class="container-fluid-left" style="color: black">
  <center><h2 style="color: blue">DATA RECORD KAIZEN DEPARTEMENT PRODUKSI (BELUM VERIFIKASI)</h2></center>

  <a href="data_kzprodmng2.php" button type="submit" class="btn btn-primary">Clik Disini->Data Semua Kaizen Produksi <span class="glyphicon glyphicon-list"></span></a>
...
$sql = mysqli_query($koneksi,"SELECT * from tb_kzprod1 WHERE mngprod='' and no_kaizen LIKE 'P%' ORDER BY id ASC");
}
...
<br>
<br>
<center><h2>Kaizen yang belum di Verifikasi akan muncul disini...</h2></center>
