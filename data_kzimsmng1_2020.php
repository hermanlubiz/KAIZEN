...
<div class="container-fluid-left" style="color: black">
  <center><h2 style="color: blue">DATA RECORD KAIZEN DEPARTEMENT IMS-HSE 2020</h2></center>

  <a href="data_kzimsmng1.php" button type="submit" class="btn btn-primary">Data Tahun 2021 <span class="glyphicon glyphicon-check"></span></a>
  ...
  <?php
  include "koneksi.php";
  $sql = mysqli_query($koneksi,"SELECT * from tb_kzprod2020 WHERE no_kaizen LIKE 'S%' ORDER BY id ASC");
  ...
  <a href="data_kzimsmng1_task.php" button type="submit" class="btn btn-primary">Klik Disini->Data Kaizen HSE (Belum Verifikasi) <span class="glyphicon glyphicon-list"></span></a>
  ...
  <div class="form-group row button" style="margin-top: 0.5%;">
     ...
     <a href="data_kzimsmng1.php" type="submit" class="btn btn-danger">Back <span class="glyphicon glyphicon-repeat"></span></a>
   </div>
