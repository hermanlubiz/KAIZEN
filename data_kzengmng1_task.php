...
<div class="container-fluid-left" style="color: black">
  <center><h2 style="color: blue">DATA RECORD KAIZEN DEPARTEMENT EGINEERING BELUM VERIFIKASI</h2></center>

  <a href="data_kzengmng1.php" button type="submit" class="btn btn-primary">Clik Disini->Data Semua Kaizen Engineering <span class="glyphicon glyphicon-list"></span></a>
...
$sql = mysqli_query($koneksi,"SELECT * from tb_kzprod1 WHERE mngprod='' and no_kaizen LIKE 'E%' ORDER BY id ASC");
}
