    ...
    <div class="container">
     ...
     <table border="1" width="75%">
      ...
      <div class="col-xs-3" style="width: 17%">
       <h4>Verification Here</h4>
        <select class="form-control" type="text" name="spvoe" required>
         <option value="">
          <option style="color:blue">DISETUJUI</option>
          <option style="color:red">DITOLAK</option>
          <option style="color:black">REVIEW</option>
      ...
      <input type="text" name="ttdoe" value="<?php echo $dataku->ttdoe ?>" style="display: none;">
      ...
      <div class="form-group row" style="display:none; ;">
      <div class="col-xs-3" style="width: 36.5%">
        <label><h4>Komentar</h4></label>
        <textarea rows="4" cols="4" type="text" name="komen2" class="form-control"><?php echo $dataku->komen2 ?></textarea>
      </div>
      </div>
      <div class="form-group row" style="display: none;">
