...
<a href="data_kzprod2.php" button type="submit" class="btn btn-primary">Klik Disini->Data Semua Kaizen Production <span class="glyphicon glyphicon-list"></span></a>
...
$sql = mysqli_query($koneksi,"SELECT * from tb_kzprod1 WHERE dikaji='' and no_kaizen LIKE 'P%' ORDER BY id ASC");
}
