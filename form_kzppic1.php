  ...
  $nama_gambar_baru2 = $angka_acak.'-'.$gm14; //menggabungkan angka acak dengan nama file sebenarnya
        ...
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {     
          ...
          // start php mailer;
                          ...
                          if ($a15=="Lidia Puspa Agustiani"){
                          $mail->AddAddress('lidia.agustiani@darya-varia.com');
                          }else ($a15=="Pudji Rahayu"){
                          $mail->AddAddress('fudji.rahayu@darya-varia.com')
                          };

                          $mail->AddCC('abdullah.swandy@darya-varia.com');
...
// end php mailer
                    ...
                    echo "<script>alert('Data berhasil ditambah.');window.location='form_kzppic1.php';</script>";
                  }

            }
            } else {     
             //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                echo "<script>alert('Ekstensi gambar yang boleh hanya jpg, png atau gif.');window.location='form_kzppic1.php';</script>";
            }
}
} else {
   $query = "INSERT INTO tb_kzprod1 (id,no_kaizen,area,oleh,judul,alasan,tipe,cat,masalah,tindakan,dampak,sebelum,img1,sesudah,img2,nm_spv,tgl_mulai,tgl_selesai,rps,mngprod,komen1,spvoe,komen2,status,ttdmng,ttdoe) 
