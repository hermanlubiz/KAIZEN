...
<body>
  ...
  <!-- Modal -->
   <div class="modal-dialog modal-lg">
        ...
        <h3 class="modal-title" style="color: white"><center>VERIFICATION KAIZEN (SPV)</center></h3>
    </div>
    ...
    <div class="container">
     ...
     <table border="1" width="75%">
        ...
        <tr>
          <td><textarea rows="6" cols="1" class="form-control" name="judul" required readonly><?php echo $dataku->judul ?></textarea></td>
          <td><textarea rows="6" cols="1" class="form-control" name="alasan" required readonly><?php echo $dataku->alasan ?></textarea></td>
        </tr>
        <tr>
          <td>
          <center>
      ...
      <table border="1" width="75%">
        ...
        <tr>
          <td><textarea rows="8" cols="1" class="form-control" name="masalah" required readonly><?php echo $dataku->masalah ?></textarea></td>
          <td><textarea rows="8" cols="1" class="form-control" name="tindakan" required readonly><?php echo $dataku->tindakan ?></textarea></td>
          <td><textarea rows="8" cols="1" class="form-control" name="dampak" required readonly><?php echo $dataku->dampak ?></textarea></td>
        </tr>
      </table>
        ...
        <tr>
          <td>
            <?php
             ...
             ?>
            <input class="form-control" type="date" name="tgl_mulai" required readonly style="pointer-events: none" value="<?php echo $nedate2 ?>">
          </td>
          <td>
            <?php
             ...
             ?>
            <input class="form-control" type="date" name="tgl_selesai" required readonly style="pointer-events: none" value="<?php echo $nedate3 ?>">
          </td>
        </tr>
      </table>
      ...
      <table border="1" width="75%">
        <tr>
          ...
          <td width="37.5%" style="background-color: #ebebe0"><center>DIKAJI OLEH (SPV)</center></td>
        </tr>
        <td><textarea rows="6" cols="1" class="form-control" name="rps" readonly><?php echo $dataku->rps ?></textarea></td>
    ...
    <div class="form-group row" style="display: none;">
      ...
      include "koneksi.php";
       ...
       //$urut   = substr($kd, 5, 0);
          ...
          if (strpbrk($kdc, P)){
            $ke2 = "data_kzprod2_task.php";
          }else if (strpbrk($kdc, A)) {
            $ke2 = "data_kzqa1_task.php";
          }else if (strpbrk($kdc, C)){
            $ke2 = "data_kzqc1_task.php";
