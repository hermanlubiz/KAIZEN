...
<div class="container-fluid-left" style="color: black">
  <center><h2 style="color: blue">DATA RECORD KAIZEN DEPARTEMENT EGINEERING 2020</h2></center>

  <a href="data_kzengmng1.php" button type="submit" class="btn btn-primary">Data Tahun 2021 <span class="glyphicon glyphicon-check"></span></a>

  <a href="exportxl_kzprod1.php" button type="submit" class="btn btn-warning disabled">Save All Data To Excel  <span class="glyphicon glyphicon-download-alt"></span></a>
  <?php
  include "koneksi.php";
  $sql = mysqli_query($koneksi,"SELECT * from tb_kzprod2020 WHERE no_kaizen LIKE 'E%' ORDER BY id ASC");
  $count = mysqli_num_rows($sql);
  ?>
  <button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-home"></span> Total Data Kaizen Engineering <span class="badge"><?php echo $count ?></span></button>

  <a href="data_kzengmng1_task.php" button type="submit" class="btn btn-primary">Klik Disini->Data Kaizen Engineering (Belum Verifikasi) <span class="glyphicon glyphicon-list"></span></a>
  ...
  <div class="form-group row button" style="margin-top: 0.5%;">
     ...
     <a href="data_kzengmng1.php" type="submit" class="btn btn-danger">Back <span class="glyphicon glyphicon-repeat"></span></a>
   </div>
...
<!-- untuk tabel scroll-->
<div  class="container-fluid-left" style="color: black;position: absolute-block;max-height: 655px;width:101.7%;overflow-y:auto;overflow-x:hidden;margin-top: 4.2%" >
