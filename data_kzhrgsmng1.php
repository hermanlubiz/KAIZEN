...
<div class="container-fluid-left" style="color: black">
  <center><h2 style="color: blue">DATA RECORD KAIZEN DEPARTEMENT HRGS/PLANT MANAGEMENT</h2></center>

  <a href="data_kzhrgsmng1_2020.php" button type="submit" class="btn btn-primary">Data Tahun 2020 <span class="glyphicon glyphicon-check"></span></a>
  ...
  <?php
  include "koneksi.php";
  $sql = mysqli_query($koneksi,"SELECT * from tb_kzprod1 WHERE no_kaizen LIKE 'H%' ORDER BY id ASC");
...
$sql = mysqli_query($koneksi,"SELECT * from tb_kzprod1 WHERE no_kaizen LIKE 'H%' ORDER BY id DESC");
}
