...
<a href="form_kzprod2.php" button type="submit" class="btn btn-primary">+ Tambah Input <span class="glyphicon glyphicon-check"></span></a>
  ...
  <a href="data_kzprod2_task.php" button type="submit" class="btn btn-primary">Klik Disini->Data Kaizen Production (Belum Verifikasi) <span class="glyphicon glyphicon-list"></span></a>
  ...
  <div class="form-group row button" style="margin-top: 0.5%;">
     ...
     <a href="data_kzprod2.php" type="submit" class="btn btn-danger">Back <span class="glyphicon glyphicon-repeat"></span></a>
   </div>
   <div class="col-xs-1" style="width: 20%; ;margin-left: -3.5%">
...
$sql = mysqli_query($koneksi,"SELECT * from tb_kzprod1 WHERE no_kaizen LIKE 'P%' ORDER BY id DESC");
}
